...
if (isset($_GET["consulta"])) {
    ...
    $sql = "SELECT * FROM pedidos WHERE nome LIKE '%$consulta%'";
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $loja = $connection->real_escape_string($_POST["loja"]);
        ...
        $sql = "INSERT INTO pedidos (nome, loja, condominio, preco) VALUES ('$nome', '$loja', '$condominio', '$preco')";
